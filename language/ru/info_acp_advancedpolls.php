...
$lang = array_merge($lang, array(
	...
	'AP_ACT_POLL_NO_VOTE_EXPLAIN'	=> 'Изменяет стандартное значение ссылки "Показать голоса"  на "Не хочу  голосовать", что не позволит голосовать после просмотра результатов, если "Переголосование" не выбрано.',
