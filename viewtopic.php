...
if (!empty($topic_data['poll_start']))
{
	...
	* @var	array	poll_template_data				Array with the poll template data
	...
	* @var	bool	s_display_results				Flag indicating if the results are to be displayed
	* @var	int		topic_id						The id of the topic the user tries to access
	* @var	array	topic_data						All the information from the topic and forum tables for this topic
	...
	*/
	...
	unset($poll_end, $poll_info, $voted_id, $poll_template_data, $poll_options_template_data);
}
